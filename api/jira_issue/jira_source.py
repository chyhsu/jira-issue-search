...
def fetch_by_query(query, num_of_issues_to_fetch=1000):
    ...
    while total is None or start_at < total:
        ...
        issues = JIRA_CLIENT.search_issues(
            ...
            fields='key,summary,status,description,created,issuetype,assignee'
        )
...
def fetch_by_id(jira_id):
    ...
    # Fetch the issue
    issue = JIRA_CLIENT.issue(jira_id, fields='key,summary,status,description,created,issuetype,assignee')
